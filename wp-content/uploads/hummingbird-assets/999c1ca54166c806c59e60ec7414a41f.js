...
(function($){
    ...
    mnfixed.prototype.init = function(){
		...
		if($(window).width()<=849){
			//alert('dddd');
			_.ele.css({ 
				"width" : $(window).width() + "px","overflow-y" : "hidden","overflow-x" : "auto","-webkit-overflow-scrolling": "touch", "height": "64px",   "white-space": "nowrap"
			});
		}
		//_.self.parents(".mnfixed_wrap").hide();
    }
    ...
    mnfixed.prototype.A = function(){
		...
		if($(window).width()<=849){
			//alert('dddd');
			_.ele.css({ 
				"width" : $(window).width() + "px","overflow-y" : "hidden","overflow" : "auto","-webkit-overflow-scrolling": "touch", "height": "64px",   "white-space": "nowrap"
			});
		}
