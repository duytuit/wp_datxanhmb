...
function check_schema_list_product($script_schema) {
   global $schema_list_products;
   $schema_list_products = $script_schema;
}

add_action('get_schema_list_product','check_schema_list_product');
function check_schema_product() {
  global $product_detail;
  $product_detail = 123321;
}
